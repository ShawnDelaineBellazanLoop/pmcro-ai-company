...
"@
    ...
    @{ name="evolve-colony"; description="Kick a PMCR-O cycle scoped to CEO to evolve the Colony itself -- add a command, sub-agent, or domain in response to a capability gap. Usage: /ceo:evolve-colony <capability gap or missing command, e.g. 'coo needs an incident-severity classifier'>";
       body=@"
